...
public class LetsRoll extends CommandBase {
  ...
  public void execute() {
    ...
    if (move) {
      ...
      driveTrain.drive((left.getX() * Parameters.currentDriverProfile.MAX_SPEED), (left.getY() * Parameters.currentDriverProfile.MAX_SPEED), Math.toRadians(right.getX() * Parameters.currentDriverProfile.MAX_TURN_SPEED), Parameters.currentDriverProfile.FIELD_CENTRIC);
    }
