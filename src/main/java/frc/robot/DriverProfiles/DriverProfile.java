...
public class DriverProfile {
    ...
    public DriverProfile(String NAME, double JOYSTICK_DEADZONE, double MAX_TURN_SPEED, double DRIVE_RAMP_RATE, boolean LOCKEM_UP, boolean FIELD_CENTRIC, double MAX_SPEED, IdleMode DRIVE_IDLE_MODE) {
        this.NAME              = NAME;
